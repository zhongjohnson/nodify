...
namespace Nodify
{
    public class MinimapItem : ContentControl
    {
        ...
        public static readonly StyledProperty<Point> LocationProperty = ItemContainer.LocationProperty.AddOwner<MinimapItem>(new StyledPropertyMetadata<Point>(default, defaultBindingMode: Avalonia.Data.BindingMode.TwoWay));
